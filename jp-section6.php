		...
		<div class="container">
			<div class="row header">
				...
				<div class="col-md-12 filtering">
					<ul id="filters">
                        <li><a href="#" data-filter="*" class="active">一般的な</a></li>
                        <!--lookup mobile devices interfaces etc in css files-->
                        <li><a href="index.php?lang=<?php echo $pageLang; ?>&section=6.1">特殊</a></li>
                        <li><a href="index.php?lang=<?php echo $pageLang; ?>&section=6.2">出来映え</a></li>
                    </ul>
				</div>
			</div>
