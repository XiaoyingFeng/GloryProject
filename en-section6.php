		...
		<div class="container">
			<div class="row header">
				...
				<div class="col-md-12 filtering">
					<ul id="filters">
                        <li><a href="#" data-filter="*" class="active">General</a></li>
                        <!--lookup mobile devices interfaces etc in css files-->
                        <li><a href="index.php?lang=<?php echo $pageLang; ?>&section=6.1">Special Treatment</a></li>
                        <li><a href="index.php?lang=<?php echo $pageLang; ?>&section=6.2">Workmanship</a></li>
                    </ul>
				</div>
			</div>
			<div class="row gallery_container">
				...
				<div class="col-md-4">
					<iframe width="1280" height="720" src="https://www.youtube.com/embed/1L0OXR-51k0?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
